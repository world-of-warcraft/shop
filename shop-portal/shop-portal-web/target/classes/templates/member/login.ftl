		...
		<form action="login" method="post">
			<div class="layui-form">
				...
				<div class="layui-input-block getCode">
					<input type="text" name="graphicCode" required
				...
				<button class="layui-btn" style="margin-top: 5px;" lay-submit
					lay-filter="user-login">登录</button>

				<div style="margin-top: 20px">
					<img alt="" src="../res/static/img/social-qq.png"
						style="height: 25px; width: 25px; margin-left: 45%;" onclick="javascript:location.href='qqAuth'"> <img
						alt="" src="../res/static/img/weixin_logo.png"
